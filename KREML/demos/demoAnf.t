  ...
  (AFun ("cc_1", ["k"; "n"; "m"],
     (ALet ("anf_1",
        ...
        (ALet ("anf_2", (CApp ((ImmIdentifier "k"), (ImmIdentifier "anf_1"))),
           (ACExpr (CImmExpr (ImmIdentifier "anf_2")))))
        ))
     ))
  (AFun ("fack", ["n"; "k"],
     (ALet ("anf_3", (CBinaryOp (LtOrEq, (ImmIdentifier "n"), (ImmInt 1))),
        (ALet ("anf_4", (CApp ((ImmIdentifier "k"), (ImmInt 1))),
           (ALet ("anf_5", (CBinaryOp (Sub, (ImmIdentifier "n"), (ImmInt 1))),
              (ALet ("anf_6",
                 ...
                 (ALet ("anf_7",
                    ...
                    (ALet ("anf_8",
                       ...
                       (ALet ("anf_9",
                          (CApp ((ImmIdentifier "anf_6"),
                             (ImmIdentifier "anf_8"))),
                          (ACExpr
                             (CIfThenElse ((ImmIdentifier "anf_3"),
                                (ImmIdentifier "anf_4"),
                                (ImmIdentifier "anf_9"))))
                          ))
                       ))
  ...
  (AFun ("fac", ["n"],
     (ALet ("anf_10", (CApp ((ImmIdentifier "fack"), (ImmIdentifier "n"))),
        (ALet ("anf_11",
